...
public:
    ...
    virtual void Execute(LPCSTR /*args*/)
    {
        ...
        const u32* mem_usage = HW.m_stats_manager.memory_usage_summary[enum_stats_buffer_type_vertex];
        ...
        mem_usage = HW.m_stats_manager.memory_usage_summary[enum_stats_buffer_type_rtarget];
