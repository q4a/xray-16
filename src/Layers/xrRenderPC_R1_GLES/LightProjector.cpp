...
//    CHK_DX(HW.pDevice->Clear(0, nullptr, D3DCLEAR_ZBUFFER | (HW.Caps.bStencil ? D3DCLEAR_STENCIL : 0), 0, 1, 0));
    HW.pDevice->ClearDepthStencilView(RCache.get_ZB(), D3D_CLEAR_DEPTH | (HW.Caps.bStencil ? D3D_CLEAR_STENCIL : 0), 1.0f, 0L);
...
//        CHK_DX(HW.pDevice->Clear(0, nullptr, D3DCLEAR_TARGET, color_rgba_f(cap.x, cap.y, cap.z, (cap.x + cap.y + cap.z) / 4.f), 1, 0));
		FLOAT ColorRGBA[4] = { cap.x, cap.y, cap.z, (cap.x + cap.y + cap.z) / 4.f };
