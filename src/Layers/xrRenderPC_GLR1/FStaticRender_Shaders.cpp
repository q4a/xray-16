...
HRESULT CRender::shader_compile(pcstr name, IReader* fs, pcstr pFunctionName, pcstr pTarget, u32 Flags, void*& result)
{
    ...
    strconcat(sizeof(filename), filename, "glr1" DELIMITER, name, ".", extension);

    string_path folder_name, folder;
    strconcat(sizeof(folder), folder, "glr1" DELIMITER "objects" DELIMITER, filename);
...
*/
    ...
    strconcat(sizeof(filename), filename, "glr1" DELIMITER, name, ".", extension, DELIMITER, sh_name.c_str());
